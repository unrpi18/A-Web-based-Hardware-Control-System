...
const APPOINTMENT_ADMIN_VIEW = () => {
    ...
    return (
        <div>
            ...
            <TableContainer>
                <Table sx={{ maxWidth: '60vw', maxHeight : '25vh', border : 3, mx :'auto', mt : '15vh'}} aria-label="simple table" title = "test">
                    <TableHead>
                        <TableRow>
                        ...
                        >
                            ...
                            <TableCell align="center" sx ={{maxWidth : '6vw', bgcolor : rows[row.ts_id].Mon=== 'Free' ? 'green': 'red'}} >
                                <Stack>
                                    ...
                                    <ButtonGroup orientation="horizontal" size = "small"  variant="standard" aria-label="outlined primary button group">
                                        ...
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Mon !== 'Booked' }> CXL </Button>
                                    </ButtonGroup>
                                </Stack>
                            ...
                            <TableCell align="center" sx ={{maxWidth : '6vw', bgcolor : rows[row.ts_id].Tue !== 'Free' ? 'red': 'green'}}>
                                <Stack>
                                    {row.Tue}
                                    <ButtonGroup orientation="horizontal" size = "small"  variant="standard" aria-label="outlined primary button group">
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Tue  !== 'Free' }> Book </Button>
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Tue !== 'Booked' }> CXL </Button>
                                    </ButtonGroup>
                                </Stack>
                            ...
                            <TableCell align="center" sx ={{maxWidth : '6vw', bgcolor : rows[row.ts_id].Wed !== 'Free' ? 'red': 'green'}}>
                                <Stack>
                                    {row.Wed}
                                    <ButtonGroup orientation="horizontal" size = "small"  variant="standard" aria-label="outlined primary button group">
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Wed  !== 'Free' }> Book </Button>
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Wed !== 'Booked' }> CXL </Button>
                                    </ButtonGroup>
                                </Stack>
                            ...
                            <TableCell align="center" sx ={{maxWidth : '6vw', bgcolor : rows[row.ts_id].Thu !== 'Free' ? 'red': 'green'}}>
                                <Stack>
                                    {row.Thu}
                                    <ButtonGroup orientation="horizontal" size = "small"  variant="standard" aria-label="outlined primary button group">
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Thu  !== 'Free' }> Book </Button>
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Thu !== 'Booked' }> CXL </Button>
                                    </ButtonGroup>
                                </Stack>
                            ...
                            <TableCell align="center" sx ={{maxWidth : '6vw', bgcolor : rows[row.ts_id].Fri !== 'Free' ? 'red': 'green'}}>
                                <Stack>
                                    {row.Fri}
                                    <ButtonGroup orientation="horizontal" size = "small"  variant="standard" aria-label="outlined primary button group">
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Fri  !== 'Free' }> Book </Button>
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Fri !== 'Booked' }> CXL </Button>
                                    </ButtonGroup>
                                </Stack>
                            ...
                            <TableCell align="center" sx ={{maxWidth : '6vw', bgcolor : rows[row.ts_id].Sat !== 'Free' ? 'red': 'green'}}>
                                <Stack>
                                    {row.Sat}
                                    <ButtonGroup orientation="horizontal" size = "small"  variant="standard" aria-label="outlined primary button group">
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Sat  !== 'Free' }> Book </Button>
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Sat !== 'Booked' }> CXL </Button>
                                    </ButtonGroup>
                                </Stack>
                            ...
                            <TableCell align="center" sx ={{maxWidth : '6vw', bgcolor : rows[row.ts_id].Sun !== 'Free' ? 'red': 'green'}}>
                                <Stack>
                                    {row.Sun}
                                    <ButtonGroup orientation="horizontal" size = "small"  variant="standard" aria-label="outlined primary button group">
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Sun  !== 'Free' }> Book </Button>
                                        <Button size = "small" sx ={{bgcolor : 'transparent',color : 'white'}} disabled ={rows[row.ts_id].Sun !== 'Booked' }> CXL </Button>
                                    </ButtonGroup>
                                </Stack>
