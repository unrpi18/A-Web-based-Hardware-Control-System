                                    ...
                                    <TableCell align="center" sx={{
                                        ...
                                        <Stack>
                                            ...
                                            <Button size="small" sx={{bgcolor: 'transparent', color: 'white'}}
                                                ...
                                                (rows[row.ts_id].Mon === 'Free') ? "Book " : ((rows[row.ts_id].Mon === 'Booked') ? "CANCEL" :
                                    ...
                                    <TableCell align="center" sx={{
                                        ...
                                        <Stack>
                                            ...
                                            <Button size="small" sx={{bgcolor: 'transparent', color: 'white'}}
                                                ...
                                                (rows[row.ts_id].Tue === 'Free') ? "Book " : ((rows[row.ts_id].Tue === 'Booked') ? "CANCEL" :
                                                    <Typography variant="caption" display="block" color='transparent'
                                                                gutterBottom>
                                                        {display}
                                                    </Typography>)}
                                    ...
                                    <TableCell align="center" sx={{
                                        ...
                                        <Stack>
                                            ...
                                            <Button size="small" sx={{bgcolor: 'transparent', color: 'white'}}
                                                ...
                                                (rows[row.ts_id].Wed === 'Free') ? "Book " : ((rows[row.ts_id].Wed === 'Booked') ? "CANCEL" :
                                                    <Typography variant="caption" display="block" color='transparent'
                                                                gutterBottom>
                                                        {display}
                                                    </Typography>)}
                                    ...
                                    <TableCell align="center" sx={{
                                        ...
                                        <Stack>
                                            ...
                                            <Button size="small" sx={{bgcolor: 'transparent', color: 'white'}}
                                                ...
                                                (rows[row.ts_id].Thu === 'Free') ? "Book " : ((rows[row.ts_id].Thu === 'Booked') ? "CANCEL" :
                                                    <Typography variant="caption" display="block" color='transparent'
                                                                gutterBottom>
                                                        {display}
                                                    </Typography>)}
                                    ...
                                    <TableCell align="center" sx={{
                                        ...
                                        <Stack>
                                            ...
                                            <Button size="small" sx={{bgcolor: 'transparent', color: 'white'}}
                                                ...
                                                (rows[row.ts_id].Fri === 'Free') ? "Book " : ((rows[row.ts_id].Fri === 'Booked') ? "CANCEL" :
                                                    <Typography variant="caption" display="block" color='transparent'
                                                                gutterBottom>
                                                        {display}
                                                    </Typography>)}
                                    ...
                                    <TableCell align="center" sx={{
                                        ...
                                        <Stack>
                                            ...
                                            <Button size="small" sx={{bgcolor: 'transparent', color: 'white'}}
                                                ...
                                                (rows[row.ts_id].Sat === 'Free') ? "Book " : ((rows[row.ts_id].Sat === 'Booked') ? "CANCEL" :
                                                    <Typography variant="caption" display="block" color='transparent'
                                                                gutterBottom>
                                                        {display}
                                                    </Typography>)}
                                    ...
                                    <TableCell align="center" sx={{
                                        ...
                                        <Stack>
                                            ...
                                            <Button size="small" sx={{bgcolor: 'transparent', color: 'white'}}
                                                ...
                                                (rows[row.ts_id].Sun === 'Free') ? "Book " : ((rows[row.ts_id].Sun === 'Booked') ? "CANCEL" :
                                                    <Typography variant="caption" display="block" color='transparent'
                                                                gutterBottom>
                                                        {display}
                                                    </Typography>)}
